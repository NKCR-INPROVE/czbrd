...
public class Options {
    ...
    public Options() throws IOException, JSONException {
        String path = System.getProperty("user.home") + File.separator + ".czbrd" + File.separator + "conf.json";
        File fdef = FileUtils.toFile(Options.class.getResource("/cz/incad/czbrd/conf.json"));
